...
<tagfile doxygen_version="1.9.8">
  ...
  <compound kind="file">
    <name>secure_lang.cpp</name>
    <path></path>
    <filename>d2/d35/secure__lang_8cpp.html</filename>
  ...
  <compound kind="namespace">
    ...
    <member kind="function">
      <type>std::string</type>
      <name>to_string</name>
      <anchorfile>df/dc1/namespacesecure.html</anchorfile>
      <anchor>a111c484fbf4d62120d4412ed93bdc686</anchor>
      <arglist>(const ValuePtr &amp;val)</arglist>
    </member>
  </compound>
  <compound kind="namespace">
  ...
  <compound kind="page">
    ...
    <filename>d0/d30/md_README.html</filename>
  </compound>
  <compound kind="page">
    <name>md_CLAUDE</name>
    <title>CLAUDE.md</title>
    <filename>d8/d00/md_CLAUDE.html</filename>
  </compound>
  <compound kind="page">
    <name>index</name>
    <title>Aperture Language Design Document</title>
    <filename>index.html</filename>
    <docanchor file="index.html" title="Aperture Language Design Document">md_docs_2DESIGN</docanchor>
  </compound>
</tagfile>
